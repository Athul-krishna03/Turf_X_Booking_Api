...
import { IReviewModel, ReviewModel } from "../../../frameworks/database/models/review.model";
...
export class ReviewRepository extends BaseRepository<IReviewModel> implements IReviewRepository{
    ...
    async findOne({ turfId, reviewerId }: { turfId: string; reviewerId: string }): Promise<IReviewEntity | null> {
